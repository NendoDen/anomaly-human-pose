...
def eval_combined_model(args):
    ...
    #   print(k, trajectories[k].coordinates.shape)
    #   print(trajectories[k].frames)
    ...
    # for k in global_trajectories.keys():
    #   print(k, global_trajectories[k].coordinates)
    #   break
    ...
    # print(trajectories_ids, frames, X_global)
    ...
    if pred_length > 0:
        ...
        print(pred_ids, pred_frames, pred_errors)
